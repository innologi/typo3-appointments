...
/**
 * Test case for class Tx_Appointments_Controller_AppointmentController.
 *
 * @version $Id$
 ...
 */
class Tx_Appointments_Controller_AppointmentControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
