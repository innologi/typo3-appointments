...
/**
 * Test case for class Tx_Appointments_Controller_TypeController.
 *
 * @version $Id$
 ...
 */
class Tx_Appointments_Controller_TypeControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
