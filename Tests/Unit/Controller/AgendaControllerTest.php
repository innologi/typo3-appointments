...
/**
 * Test case for class Tx_Appointments_Controller_AgendaController.
 *
 * @version $Id$
 ...
 */
class Tx_Appointments_Controller_AgendaControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
