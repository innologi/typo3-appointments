    ...
    'columns' => [
        ...
        'validation_types' => [
            ...
            'config' => [
                ...
                'items' => [
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.datetime', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_DATE_TIME],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.email', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_EMAIL_ADDRESS],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.float', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_FLOAT],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.integer', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_INTEGER],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.notempty', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_NOT_EMPTY],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.number', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_NUMBER],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.validation_types.naturalnumber', 'value' => \Innologi\Appointments\Domain\Model\FormField::VALIDATE_NATURALNUMBER],
                ],
                'size' => 7,
                'maxitems' => 99,
                'multiple' => 0,
        ...
        'field_type' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.field_type.boolean', 'value' => \Innologi\Appointments\Domain\Model\FormField::TYPE_BOOLEAN],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.field_type.radio', 'value' => \Innologi\Appointments\Domain\Model\FormField::TYPE_RADIO],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.field_type.select', 'value' => \Innologi\Appointments\Domain\Model\FormField::TYPE_SELECT],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.field_type.textsmall', 'value' => \Innologi\Appointments\Domain\Model\FormField::TYPE_TEXTSMALL],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.field_type.textlarge', 'value' => \Innologi\Appointments\Domain\Model\FormField::TYPE_TEXTLARGE],
                ],
                'size' => 1,
                'maxitems' => 1,
        ...
        'function' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.function.info', 'value' => \Innologi\Appointments\Domain\Model\FormField::FUNCTION_INFORMATIONAL],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.function.addtime', 'value' => \Innologi\Appointments\Domain\Model\FormField::FUNCTION_ADDTIME],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.function.email', 'value' => \Innologi\Appointments\Domain\Model\FormField::FUNCTION_EMAIL],
                ],
                'size' => 1,
                'maxitems' => 1,
            ],
        ...
        'enable_field' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.enable_field.default', 'value' => 0],
                    ['label' => 'LLL:EXT:appointments/Resources/Private/Language/locallang_db.xml:tx_appointments_domain_model_formfield.div.enable_field', 'value' => '--div--'],
                ],
