...
return [
    ...
    'types' => [
        '0' => [
            'showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, agenda, type,
    ...
    'palettes' => [
        'times' => [
            'showitem' => 'begin_time, end_time, --linebreak--, begin_reserved, end_reserved',
        ],
    ],
    'columns' => [
        'sys_language_uid' => [
        ...
        'creation_progress' => [
            #@TODO gebruik de displayCond en een user function misschien, om tekstueel toe te lichten wat de status is?
            'exclude' => 1,
