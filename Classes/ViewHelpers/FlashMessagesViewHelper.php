...
class FlashMessagesViewHelper extends AbstractViewHelper
{
     ...
     *
     * TYPO3\CMS\Fluid\ViewHelpers\FlashMessagesViewHelper Note:
     *       This does not disable the current page cache in order to prevent FlashMessage output
     *       from being cached.
     ...
     *
     * In this variation, we've reinstated the original TYPO3 6.2 behavior per sponsor request.
     *
        ...
        if ($queueIdentifier === null) {
            ...
            if (!$request instanceof RequestInterface) {
                ...
                throw new \RuntimeException(
                    'ViewHelper a:flashMessages needs an extbase Request object to resolve the Queue identifier magically.'
