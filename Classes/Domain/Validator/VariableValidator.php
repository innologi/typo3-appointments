 ...
 *
 */
class Tx_Appointments_Domain_Validator_VariableValidator extends Tx_Appointments_Validation_Validator_PreppedAbstractValidator {
	...
	public function isValid($value) {
		...
		#@LOW throw exception when option isn't set, instead of just returning FALSE
